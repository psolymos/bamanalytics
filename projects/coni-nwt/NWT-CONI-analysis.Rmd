...
Tue, Jan 14, 1:22 PM (1 day ago)
	
to Elly, Samuel, Rhiannon, Erin
Thinking a bit more (and making sure that the last step works in the program), here is the decision tree I cam up with.
...
plogis(o$par) # delta (prob of nonzero) and q (prob of use)
delta <- plogis(o$par[1])
q <- plogis(o$par[2])
