...
lines(0:length(mods)+0.5, auc, col=4, lwd=2)
text(0:length(mods)+0.5, auc, round(auc, 3), col=2)
```

```{r echo=FALSE,message=FALSE,fig.width=7,fig.height=4,results='hide'}
op <- par(mfrow=c(1,2))
plot(rocAll1[["NULL"]], col=4)
plot(rocAll1[["Clim"]], col=4)
par(op)
```
...
par(mfrow=c(1,2))
boxplot(mn[,"NULL"] * exp(off1[ss1]) ~ Y[ss1], range=0,
...
![](e:/peter/bam/pred-2016/maps/CAWA-6-2012-2016-08-16-det.png)

## 2012 landscape conditions

### Median density

![](e:/peter/bam/pred-2016/maps/CAWA-6-2016-08-16-mean-2012.png)

### Coefficient of variation

![](e:/peter/bam/pred-2016/maps/CAWA-6-2012-2016-08-16-cov.png)

### Standard deviation

![](e:/peter/bam/pred-2016/maps/CAWA-6-2012-2016-08-16-sd.png)

## 2002 landscape conditions

### Median density

![](e:/peter/bam/pred-2016/maps/CAWA-6-2016-08-16-mean-2002.png)

### Ratio of median density: 2012 / 2002

![](e:/peter/bam/pred-2016/maps/CAWA-6-2002-2016-08-16-diff-2002-2012.png)

## Backfilled landscape conditions

### Median density

![](e:/peter/bam/pred-2016/maps/CAWA-6-2016-08-16-mean-2012bf.png)

### Ratio of median density: 2012 / backfilled

![](e:/peter/bam/pred-2016/maps/CAWA-6-2002-2016-08-16-diff-bfill-2012.png)
...
```{r echo=FALSE}
x0 <- read.csv("e:/peter/bam/pred-2016/maps/CAWA-6-2012-2016-08-16-2012-bf-totals.csv")
x1 <- read.csv("e:/peter/bam/pred-2016/maps/CAWA-6-2002-2016-08-16-2002-totals.csv")
x2 <- read.csv("e:/peter/bam/pred-2016/maps/CAWA-6-2012-2016-08-16-2012-totals.csv")
...
fstat <- function(x, level=0.95) {
    c(Median=median(x), quantile(x, c((1-level)/2, 1 - (1-level)/2)))
}
...
p0 <- fstat(colSums(x0[,ci])/10^6, lev)
p1 <- fstat(colSums(x1[,ci])/10^6, lev)
p2 <- fstat(colSums(x2[,ci])/10^6, lev)

kable(rbind("Backfilled"=p0, "2002"=p1, "2012"=p2), digits=3)
```
...
p0 <- fstat(colSums(x0[ss,ci])/10^6, lev)
p1 <- fstat(colSums(x1[ss,ci])/10^6, lev)
p2 <- fstat(colSums(x2[ss,ci])/10^6, lev)
...
```{r echo=FALSE}
by_jurs <- data.frame(t(apply(groupSums(as.matrix(x2[,ci])/10^6, 1, x2$JURS), 1, fstat)))
...
by_bcr <- data.frame(t(apply(groupSums(as.matrix(x2[,ci])/10^6, 1, x2$bcr), 1, fstat)))
