...
tzdb <- tzdb[match(levels(dat$TZ), tzdb$TZ), c("TZ", "UTC_offset", "UTC_DST_offset")]
# add here MDT offset as numeric
tzdb
#lttz <- read.csv("~/repos/bamanalytics/lookup/tzone.csv")
#lttz <- nonDuplicated(lttz, Timezone, TRUE)
dat$MDT_offset <- tzdb$UTC_DST_offset[match(dat$TZ, tzdb$TZ)] + 6
