## response to observer in distance sampling
...
type=c("exp","norm", "thres"), int=TRUE) {
    ...
    plot(r,a0,ylim=c(0,max(a,a0)),
        xlab="r", ylab="det prob", type="l", col=4, lty=2)
...
##    -- not generalizable !!!!!!!!!!!!!!
cmultiAvoid.fit <- function(Y, D, X=NULL, type=c("exp","norm"),
...
simfunAvoid <- function(n = 10, sigma=0.8, theta=NULL, type=c("exp","norm"),
